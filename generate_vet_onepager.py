...
OUTPUT = r'C:\Users\rodri\OneDrive\Documents\DD\stitch_kanbanpro_vsl_landing_page\kanbanpro-vet-onepager.pdf'
W, H = A4   # 595 x 842 pt

# ─────────────────────────────────────────────
# HELPERS (identicos al gym — motor reutilizable)
# ─────────────────────────────────────────────
...
cv.setSubject('One-Pager Propuesta Comercial Veterinaria')
...
txt(cv, 'Gestion visual para tu veterinaria — Sin caos operativo',
    W/2, H - 95, 'Helvetica-Bold', 11.5, DARK_SURF, 'center')

txt(cv, 'Citas  ·  Cirugias  ·  Hospitalizacion  ·  Medicamentos',
...
txt(cv, 'El caos real de tu veterinaria hoy:',
    80, PAIN_TOP - 22, 'Helvetica-Bold', 11.5, GOLD)
...
# ════════════════════════════════════════════════
# 4. BENEFICIOS — 4 filas (contenido veterinaria)
# ════════════════════════════════════════════════
...
txt(cv, 'KanbanPro — Sistema Kanban para veterinarias, gyms y negocios que crecen con orden.',
